...
function declaredCandidatePaths(goal) {
  ...
  for (const record of goal?.taskRecords || []) {
    if (WORKER_PROFILES[record?.profile]?.kind !== 'write' || record?.effect !== 'workspace_write') continue;
